...
class Account:
    ...
    def __generate_key_pair(self):
        ...
        # Create the Private and Public Pem from respective keys
        # Assign to _private_pem and _public_pem
        pass
    ...
    def create_transaction(self, receiver_id, value, tx_metadata=''):
        ...
        # From the Private Pem create a Private Key Object
        # Use SHA256 Hashing Algorithm to generate hash of the transaction_message
        # Digitally sign the Hash of transaction_message with the Private Key
        # Convert the Signature into Base64 String
