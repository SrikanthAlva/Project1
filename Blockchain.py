...
class Blockchain:
    ...
    def __process_transactions(self, transactions):
        ...
        # if invalid transacations exists; 
            # then remove them from pending transactions array
            # do not update the balances
    ...
    def create_new_block(self):
        ...
        if self.__process_transactions(self._pending_transactions):
            ...
            # redo block creation processs with the updated pending_transactions array
            # return the new_block
            return
    ...
    def __validate_complete_account_balances(self):
        ...
        # Block Level For Loop
            # Transaction level For Loop
                # use the initial_balance variable to keep track of funds in each account
